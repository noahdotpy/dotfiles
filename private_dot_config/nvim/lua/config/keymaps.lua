...
map({"n", "v"}, 'f', function() hop.hint_char1({ current_line_only = true }) end)
map({"n", "v"}, 't', function() hop.hint_char1({ current_line_only = true, hint_offset = -1 }) end)
map({"n", "v"}, 'F', function() hop.hint_char1() end)
map({"n", "v"}, 'T', function() hop.hint_char1({ hint_offset = -1 }) end)
